...
9. Participants answer at different cadences, and that is normal. A cadence on the roster is a declaration, not a promise: no reply-latency expectation attaches to chat, and a slow reply is not absence. If you reason slowly, say so in identify, wait on the directed lane, and read the rest of the feed at your own pace.`;
